#!/usr/bin/env Rscript
# ===================================================================
# Compare mitochondrial methylation: 21 vs 22, 23 vs 24
...
# ===================================================================
meth_files <- list(
  "21" = "/data/Jyotirmoy/CF-Projects/External/Parisa/CFFMHS-QU-12/artemia/Artemia_Analysis_251028/methylation/mitochondrial_AU/92b1c360-ee89-4a61-af36-8541e3ee5415_SQK-NBD114-24_barcode21_mods.bed",
  "22" = "/data/Jyotirmoy/CF-Projects/External/Parisa/CFFMHS-QU-12/artemia/Artemia_Analysis_251028/methylation/mitochondrial_AU/92b1c360-ee89-4a61-af36-8541e3ee5415_SQK-NBD114-24_barcode22_mods.bed",
  "23" = "/data/Jyotirmoy/CF-Projects/External/Parisa/CFFMHS-QU-12/artemia/Artemia_Analysis_251028/methylation/mitochondrial_AU/c1405676-fa9d-4b3b-8ce4-2d2a1ac64627_SQK-NBD114-24_barcode23_mods.bed",
  "24" = "/data/Jyotirmoy/CF-Projects/External/Parisa/CFFMHS-QU-12/artemia/Artemia_Analysis_251028/methylation/mitochondrial_AU/c1405676-fa9d-4b3b-8ce4-2d2a1ac64627_SQK-NBD114-24_barcode24_mods.bed"
)
...
compare_methylation(meth_files$`21`, meth_files$`22`, "21", "22", "compare_mito_21vs22")
compare_methylation(meth_files$`23`, meth_files$`24`, "23", "24", "compare_mito_23vs24")
compare_methylation(meth_files$`21`, meth_files$`24`, "21", "24", "compare_mito_21vs24")
...
p_summary <- ggplot(all_meth, aes(x = sample, y = mean_methyl, group = 1)) +
  ...
  theme_minimal(base_size = 14) +
  labs(title = "Average mitochondrial methylation across generations",
       x = "Generation (Barcode)", y = "Mean methylation fraction")

ggsave("compare_mito_mean_methylation.png", p_summary, width = 7, height = 5, dpi = 300)
